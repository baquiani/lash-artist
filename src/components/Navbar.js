...
const Navigation = () => {
  ...
  return (
    <Navbar bg="white" variant="dark" expand="lg" className='mb-1 text-white border-bottom border-dark'>
        ...
        <Navbar.Brand as={Link} to="/" className='text-dark'>Lashes by Madalina</Navbar.Brand>
